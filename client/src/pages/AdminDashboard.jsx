                    ...
                    <div className="card mb-6">
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div className="relative flex-1">
                                <svg className="w-5 h-5 text-text-primary absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                </svg>
                                <input
                                    type="text"
                                    placeholder="Search by username..."
                                    className="w-full bg-bg-secondary border border-border rounded-lg py-3 pl-12 pr-4 text-text-primary placeholder-gray-500 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:outline-none transition-all"
                                    value={usersSearch}
                            ...
                            <div className="relative sm:w-56">
                                ...
                                <select
                                    className="w-full bg-bg-secondary border border-border rounded-lg py-3 pl-12 pr-10 text-text-primary appearance-none cursor-pointer focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:outline-none transition-all"
                                    value={usersFilter}
                                ...
                                <svg className="w-5 h-5 text-text-primary absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
